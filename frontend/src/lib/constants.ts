...
export const CANDIDATE_EMAIL = 'manuel.anda@outlook.com'
export const GITHUB_URL = 'https://github.com/cloudmanuel'
export const REPO_URL = 'https://github.com/cloudmanuel/resume'
export const LINKEDIN_URL = 'https://www.linkedin.com/in/manuel-anda'
