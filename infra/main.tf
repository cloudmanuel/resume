...
resource "aws_iam_role" "github_actions_deploy" {
  ...
  description        = "Role assumed by GitHub Actions for deploying ${var.project_name}"
}
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = [
          ...
          aws_lambda_function.deployments.arn,
